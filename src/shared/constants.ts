 ...
 */
export const MODELS_CACHE_VERSION = 20;
 ...
 */
export const MODELS_CACHE_CATALOG_DIGEST = "8720ee25";
...
export const SAVE_TURN_REPORT_COMMAND_ID = "nvidia-nim.saveLastTurnReport";
export const SAVE_SESSION_LOGS_COMMAND_ID = "nvidia-nim.saveSessionLogs";
...
export const STREAM_IDLE_TIMEOUT_MAX_MS = 3600000;
