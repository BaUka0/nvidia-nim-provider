...
This release fixes infinite looping where the model repeated the same line (e.g., `Let me fix the formatting issue:`) and polishes reliability across the extension. No config change is required — just update.
